  ...
  units: [
    {
      ...
      attacks: [
        { id: "knife", name: "短刀", damage: 7, count: 3, type: "blade", range: "melee" }, // 2026-07-08 ユーザー指定(旧9x2。隊長就任にあわせ微強化)
        {
          id: "thrown_knife",
          name: "投げナイフ",
    ...
    {
      id: "orcish_warrior",
      name: "戦士", // 2026-07-08 ユーザー指定: 隊長候補のLv2が「兵卒」だと違和感があるため改名(id不変)
      level: 2,
      hp: 58,
      ...
      attacks: [
        { id: "greatsword", name: "大剣", damage: 10, count: 3, type: "blade", range: "melee" }, // 2026-07-08 ユーザー指定(旧9x3)
      ],
      resistances: {},
      alignment: "chaotic",
      cost: 26,
    ...
    },
    {
      ...
      defenseOverrides: ORC_INFANTRY_DEFENSE_OVERRIDES,
      attacks: [
        { id: "dagger", name: "短剣", damage: 4, count: 3, type: "blade", range: "melee" },
        { id: "bow", name: "弓", damage: 8, count: 3, type: "pierce", range: "ranged" },
        { id: "fire_arrow", name: "火矢", damage: 10, count: 2, type: "fire", range: "ranged"}
      ],
      resistances: {},
      alignment: "chaotic",
      cost: 26,
    ...
    },
    {
      ...
      attacks: [
        { id: "fangs", name: "牙", damage: 5, count: 3, type: "blade", range: "melee" },
        { id: "torch", name: "松明", damage: 7, count: 3, type: "fire", range: "melee"},
        { 
          id: "net", 
          name: "網", 
          damage: 6, 
    ...
    {
      id: "orcish_assassin",
      name: "アサシン", // 2026-07-08 ユーザー指定(id不変)
      level: 2,
      hp: 36,
      ...
      defenseType: "lightfoot",
      attacks: [
        { id: "knife", name: "短刀", damage: 9, count: 2, type: "blade", range: "melee" },
        {
          id: "thrown_knife",
          name: "投げナイフ",
          damage: 6,
    ...
    },
    {
      ...
      attacks: [
        { id: "club", name: "ハンマー", damage: 14, count: 2, type: "impact", range: "melee" }, // 2026-07-08 ユーザー指定(id不変。旧棍棒)
      ],
    ...
    },
    {
      ...
      attacks: [
        { id: "sword", name: "剣", damage: 6, count: 5, type: "blade", range: "melee" }, // 2026-07-08 ユーザー指定(旧7x4→7x5は強すぎたため6x5に調整)
      ],
      resistances: {},
      alignment: "neutral",
      cost: 27,
    ...
    },
    {
      ...
      defenseOverrides: ORC_INFANTRY_DEFENSE_OVERRIDES,
      attacks: [
        { id: "sword", name: "剣", damage: 9, count: 2, type: "blade", range: "melee" },
      ],
      resistances: {},
      alignment: "chaotic",
      cost: 12,
    ...
    },
    {
      ...
      defenseOverrides: ORC_INFANTRY_DEFENSE_OVERRIDES,
      attacks: [
        { id: "dagger", name: "短剣", damage: 3, count: 2, type: "blade", range: "melee" },
        { id: "bow", name: "弓", damage: 5, count: 3, type: "pierce", range: "ranged" },
        { id: "fire_arrow", name: "火矢", damage: 7, count: 2, type: "fire", range: "ranged"}
      ],
      resistances: {},
      alignment: "chaotic",
      cost: 14,
    ...
    },
    {
      ...
      defenseType: "lightfoot",
      attacks: [
        { id: "knife", name: "短刀", damage: 7, count: 1, type: "blade", range: "melee" },
        {
          id: "thrown_knife",
          name: "投げナイフ",
          damage: 3,
    ...
    },
    {
      ...
      abilities: ["regenerates"],
      attacks: [
        { id: "fist", name: "棍棒", damage: 7, count: 2, type: "impact", range: "melee" }, // 2026-07-08 ユーザー指定(id不変。旧拳)
      ],
      // 2026-07-08 ユーザー指定: 分厚い体皮で斬撃・刺突に強いが秘術に弱い
      resistances: { blade: 20, pierce: 20, arcane: -10 },
      alignment: "chaotic",
    ...
    },
    {
      ...
      attacks: [
        { id: "sword", name: "剣", damage: 4, count: 4, type: "blade", range: "melee" },
      ],
      resistances: {},
      alignment: "neutral",
      cost: 14,
